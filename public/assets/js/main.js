...
(function () {
  ...
  if (window.templateCustomizer) {
    ...
    // Manual theme switcher without templateCustomizer
    if (styleSwitcherToggleEl) {
      let isDark = localStorage.getItem('dark-mode') === 'true';
      let icon = styleSwitcherToggleEl.querySelector('i');
      if (icon) {
        icon.className = isDark ? 'ti ti-sun ti-md' : 'ti ti-moon-stars ti-md';
      }

      function setMode(dark) {
        let html = document.querySelector('html');
        let coreLink = document.querySelector('link[href*="core.css"], link[href*="core-dark.css"]');
        let themeLink = document.querySelector('link[href*="theme-default.css"], link[href*="theme-default-dark.css"]');
        ...
        if (dark) {
          ...
          if (icon) icon.className = 'ti ti-sun ti-md';
          localStorage.setItem('dark-mode', 'true');
        } else {
          html.classList.remove('dark-style');
          html.classList.add('light-style');
          if (coreLink) coreLink.setAttribute('href', coreLink.getAttribute('href').replace('core-dark.css', 'core.css'));
          if (themeLink) themeLink.setAttribute('href', themeLink.getAttribute('href').replace('theme-default-dark.css', 'theme-default.css'));
          if (icon) icon.className = 'ti ti-moon-stars ti-md';
